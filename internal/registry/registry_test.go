...
func TestRegisterUpdate(t *testing.T) {
	...
	reg1 := &models.ServiceRegistration{
		...
		HealthCheckURL:  "http://192.168.1.10:8080/health",
		NotificationURL: "http://192.168.1.10:8080/notify",
		Subscriptions: []models.Subscription{{ServiceName: "service-a"}},
	}
	reg.Register(reg1)
	...
	reg2 := &models.ServiceRegistration{
		ServiceName:     "test-service",
		PodName:         "test-pod-1",
		Providers:       []models.ProviderInfo{{ProviderID: string(models.ProviderHTTP), Protocol: models.ProtocolHTTP, IP: "192.168.1.10", Port: 9090}},
		HealthCheckURL:  "http://192.168.1.10:9090/health",
		NotificationURL: "http://192.168.1.10:9090/notify",
		Subscriptions: []models.Subscription{{ServiceName: "service-b"}},
	}
...
func TestGetByServiceName(t *testing.T) {
	...
	for i := 1; i <= 3; i++ {
		registration := &models.ServiceRegistration{
			...
			Providers:       []models.ProviderInfo{{ProviderID: string(models.ProviderHTTP), Protocol: models.ProtocolHTTP, IP: "192.168.1.10", Port: 8080 + i}},
			HealthCheckURL:  "http://192.168.1.10:8080/health",
			NotificationURL: "http://192.168.1.10:8080/notify",
...
func TestGetSubscriberServices(t *testing.T) {
	...
	for i := 1; i <= 3; i++ {
		registration := &models.ServiceRegistration{
			...
			HealthCheckURL:  "http://192.168.1.10:8080/health",
			NotificationURL: "http://192.168.1.10:8080/notify",
			Subscriptions: []models.Subscription{{ServiceName: "target-service"}},
		}
		reg.Register(registration)
	}
...
func TestMultipleSubscriptions(t *testing.T) {
	...
	registration := &models.ServiceRegistration{
		...
		HealthCheckURL:  "http://192.168.1.10:8080/health",
		NotificationURL: "http://192.168.1.10:8080/notify",
		Subscriptions: []models.Subscription{{ServiceName: "service-a"}, {ServiceName: "service-b"}, {ServiceName: "service-c"}},
	}
	reg.Register(registration)
